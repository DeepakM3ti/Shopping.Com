<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payments.aspx.cs" Inherits="Shopping.Com.Payments" %>
        ...
        <div>
            <div style="display: flex; margin: 10px">
                <div style="display: inline-block; width: 25%; padding: 3px; border: solid thin red; padding: 5px; margin: 2px">
                    <div style="margin:10px; border:solid 1pt wheat">
                        <div>Delivery Address</div>
                        <div>
                            <asp:Label ID="lblAddress" runat="server" Text="Label"></asp:Label></div>
                    </div>
                    <div style="margin:10px; border:solid 1pt wheat">
                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="Mode" DataValueField="modeId"></asp:RadioButtonList>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyShopConnectionString %>" ProviderName="<%$ ConnectionStrings:MyShopConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [PaymentMode]"></asp:SqlDataSource>
                    </div>
                    <div style="margin:10px; border:solid 1pt wheat; padding:20px">
                        <asp:Button ID="btnPayments" runat="server" Text="Proceed to Pay" OnClick="btnPayments_Click" />
                        
                    </div>
                    <div style="margin:10px; border:solid 1pt wheat; padding:20px">
                        <asp:Label ID="lblSalesMsg" runat="server" Text=""></asp:Label>
                    </div>
                </div>
